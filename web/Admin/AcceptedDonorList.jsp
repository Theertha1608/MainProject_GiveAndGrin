<%-- 
    Document   : AcceptedDonorList
    Created on : Mar 14, 2023, 12:17:42 PM
    Author     : hp
--%>
...
<html>
    <head>
        ...
        <title>Accepted Donor List</title>
    </head>
    <body>
        ...
        String upQry="update tbn_donor set donor_vstatus=-1 where donor_id='"+request.getParameter("rid")+"'";
            if(con.executeCommand(upQry))
            {
                ...
                <script>
                    alert("Rejected");
                    window.location="AcceptedDonorList.jsp";
                                </script>
        <%
            }
        }
        ...
        <table border="1" align="center">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="AgencyList.jsp?rid=<%=rs.getString("Donor_id")%>">Reject</a>
                </td>
            </tr>
