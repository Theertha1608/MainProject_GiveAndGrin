...
<html lang="en" >
    ...
    {
        String ins="insert into tbn_agencydonation(agency_id,user_id,agencydonation_amount,agencydonation_date)values('"+session.getAttribute("aid")+"','"+request.getParameter("uid")+"','"+request.getParameter("txt_amnt")+"',curdate())";
        if(con.executeCommand(ins))
        {
            %>
      <script type="text/javascript">
            alert("Payment Completed");
                setTimeout(function(){window.location.href='AgencyHomePage.jsp'},100);
        </script>
     <%
        }
    }
                ...
                <div class="form">
                    <form method="post">
                        ...
                        <div class="card space icon-relative">
                            ...
                            <input type="number" min="1" class="input" name="txt_amnt" placeholder="Amount">
