<%-- 
    Document   : DonorTrackComplaint
    Created on : Mar 22, 2023, 11:39:52 AM
    Author     : hp
--%>
    ...
    <body>
        ...
        <form method="post">
            <table border="1" align="center">
                 ...
                 <% 
                     int i =0;
                     String selQry="select * from tbn_complaint where donor_id='"+session.getAttribute("drid")+"'";
                ...
                %> 
                   ...
                   <td>
                        <a href="DonorTrackComplaint.jsp?did=<%=rs.getString("complaint_id")%>" >Delete</a></td>
                </tr>
                <%
                    }
                %>
