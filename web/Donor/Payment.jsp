...
<html lang="en" >
    ...
    {
        String ins="insert into tbn_donation(agency_id,donor_id,donation_amount,donation_date,payment_status)values('"+request.getParameter("aid")+"','"+session.getAttribute("drid")+"','"+request.getParameter("txt_amnt")+"',curdate(),'1')";
        if(con.executeCommand(ins))
        {
            %>
      <script type="text/javascript">
            alert("Payment Completed");
                setTimeout(function(){window.location.href='DonorHomePage.jsp'},100);
        </script>
     <%
        }
    }
