<%-- 
    ...
    Created on : Mar 21, 2023, 9:06:48 PM
    Author     : hp
--%>
    ...
    <body>
        ...
        <%
            ...
            if(request.getParameter("btnsave")!=null)
            {
                ...
                String inQry="insert into tbn_complaint(complaint_date,complaint_description,user_id) values(curdate(),'"+complaint+"','"+session.getAttribute("uid")+"')";
